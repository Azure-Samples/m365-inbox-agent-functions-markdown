...
- Python 3.13+ (the agent host and local client run on it). Easiest install: [uv](https://docs.astral.sh/uv/), then `uv python install 3.13`.
...
- [Markdown vs Python variants](docs/how-it-works.md#python-vs-markdown)
