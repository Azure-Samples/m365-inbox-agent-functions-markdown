...
Deeper guides for the M365 Inbox Agent (Markdown). Start with the [README](../README.md) quickstart, then dig in here.

- **[Use cases](use-cases.md)** — three end-to-end scenarios (VIP → Teams, incident → briefing, action-required → reply), with sample data and expected output.
- **[How it works](how-it-works.md)** — architecture, the building-blocks table, the three run modes, chat-with-your-inbox, model providers, and Markdown vs Python.
